...
固定 14 章：1 核心结论 ｜ 2 关键利润驱动 ｜ 3 最新报告期透视（条件，最新期是年报时整章消失）｜
4 公司本质 ｜ 5 未来预期 ｜ 6 风险评估（红/黄灯）｜ 7 质量分汇总（脚本生成）｜ 8 估值与安全边际 ｜
9 预期差拆解 ｜ 10 同业对比 ｜ 11 周期规律（条件）｜ 12 仓位与时机决策 ｜ 13 回测复盘（条件）｜ 14 跟踪仪表盘。
