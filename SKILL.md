...
- **妙想 MCP 缺席必须显式标注「已走降级路径」，禁止静默跳过**（硬门禁与标注语句见 Phase 1「工具检查硬门禁」，缺席未标注 = 违反降级纪律）
